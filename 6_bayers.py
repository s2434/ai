...
"""OUTPUT:-
    Probability for Will Wait if there is an Alternate Restaurant: 
    Yes: Will Wait:  50.0 %
    No: Will Wait:  50.0 %
    Probability for Will Wait if there is NO Alternate Restaurant:      
    Yes: Will Wait:  50.0 %
    No: Will Wait:  50.0 %
    Probability for Will Wait if the Estimated Wait Time is 0-10 mins:  
    Yes: Will Wait:  71.42857142857143 %
    No: Will Wait:  28.57142857142857 %
    Probability for Will Wait if the Estimated Wait Time is 10-30 mins: 
    Yes: Will Wait:  50.0 %
    No: Will Wait:  50.0 %
